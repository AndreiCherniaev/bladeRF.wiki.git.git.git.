...
This warning comes up if you have a [firmware](FX3-Firmware) that is considered out-of-date and requires flashing.  Please update to the [http://nuand.com/fx3/latest.img latest firmware] using the `bladeRF-flash` or `bladeRF-cli` tool.